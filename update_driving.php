...
mysql_select_db("rto");
$rec=mysql_query("select * from dl_status where dr_no=".$_REQUEST['dr_no']);
if(!empty($rec))
{
$row=mysql_fetch_array($rec);
echo "<form action='update_driving1.php' method='get'><input type='hidden' name='dr_no' value='".$_REQUEST['dr_no']."'>";
echo "<table border='0'>";
