...
<div id="middle">
	...
	<div id="content_left">
		<div class="col_w460">
    	<h3>Status for Vehicle Registration : <?php echo $_REQUEST['veh_no']; ?> </h3>
		<div class="Hline">&nbsp;</div>
		...
		mysql_select_db("rto");
		$rec=mysql_query("select * from veh_status where veh_no='".$_REQUEST['veh_no']."' and chasis_no='".$_REQUEST['chasis_no']."'");
		echo "<center>";
