...
<?php		
		...
		mysql_select_db("rto");
		$rec=mysql_query("select * from learning where date='".$_REQUEST['date']."'");
		echo "<table border='1'>";
		...
		{
			echo "<tr><td>".$row['category']."</td><td>".$row['reg_no']."</td><td>".$row['sex']."</td><td>".$row['dob']."</td><td>".$row['fname']."</td> <td>".$row['mname']."</td> <td>".$row['qualcode']."</td> <td>".$row['add1']."".$row['add2']."</td> <td>".$row['district']."</td> <td>".$row['state']."</td> <td>".$row['pincode']."</td> <td>".$row['mobile']."</td> <td>".$row['email']."</td></tr>";
		}
