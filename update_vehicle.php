...
mysql_select_db("rto");
$rec=mysql_query("select * from veh_status where veh_no=".$_REQUEST['veh_no']);
if(!empty($rec))
{
$row=mysql_fetch_array($rec);
echo "<form action='update_vechicle1.php' method='get'><input type='hidden' name='veh_no' value='".$_REQUEST['veh_no']."'>";
echo "<table border='0'>";
