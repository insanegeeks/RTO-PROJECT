...
mysql_select_db("rto");
$rec=mysql_query("select * from permit_status where permit_no=".$_REQUEST['permit_no']);
if(!empty($rec))
{
$row=mysql_fetch_array($rec);
echo "<form action='update_permit1.php' method='get'><input type='hidden' name='permit_no' value='".$_REQUEST['permit_no']."'>";
echo "<table border='0'>";
echo "<tr><td>Update Status</td><td><input type='text' name='status' value='".$row['status']."'></td></tr>";
