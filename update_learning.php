...
mysql_select_db("rto");
$rec=mysql_query("select * from ll_status where reg_no=".$_REQUEST['reg_no']);
if(!empty($rec))
{
$row=mysql_fetch_array($rec);
echo "<form action='update_learning1.php' method='get'><input type='hidden' name='reg_no' value='".$_REQUEST['reg_no']."'>";
echo "<table border='0'>";
