...
<div id="middle">
	...
	<div id="content_left">
		<div class="col_w460">
    	<h3>Status for Learning Licence : <?php echo $_REQUEST['dr_no']; ?> </h3>
		<div class="Hline">&nbsp;</div>
		...
		mysql_select_db("rto");
		$rec=mysql_query("select * from dl_status where dr_no='".$_REQUEST['dr_no']."' and dob='".$_REQUEST['dob']."'");
		echo "<center>";
		echo "<table border='1' width='85%'>";
		$row=mysql_fetch_array($rec);
		{
		echo  "	<tr><td>Registration No.</td><td>".$row['dr_no']."</td></tr>
