...
<div id="middle">
	...
	<div id="content_left">
		<div class="col_w460">
    	<h3>Status for National Permit : <?php echo $_REQUEST['reg_no']; ?> </h3>
		<div class="Hline">&nbsp;</div>
		...
		mysql_select_db("rto");
		$rec=mysql_query("select * from permit_status where permit_no='".$_REQUEST['reg_no']."'");
		echo "<center>";
		echo "<table border='1' width='85%'>";
		$row=mysql_fetch_array($rec);
		{
		echo  "	<tr><td>Registration No.</td><td>".$row['permit_no']."</td></tr>
				<tr><td>Category</td><td>".$row['category']."</td></tr>
				<tr><td>Name</td><td>".$row['cand_name']."</td></tr>
				<tr><td>Members</td><td>".$row['members']."</td></tr>
				<tr><td>Source</td><td>".$row['source']."</td></tr>
				<tr><td>Destination</td><td>".$row['destination']."</td></tr>
				<tr><td>Vehicle Type</td><td>".$row['type']."</td></tr>
