...
<div id="middle">
	...
	<div id="content_left">
		...
		<h3>Today Application Received</h3>
		<div class="Hline">&nbsp;</div>
		<div class="cleaner_h10"></div>	
		<center>
		<table border="0" cellpadding="20" cellspacing="20">
		<tr>
			<td align="center"><form action="reuest_learning.php" method="post" name="resuestdate">
			<?php
			$date = date("d/m/y");
			echo "<input type='hidden' name='date' value=".$date.">";
			echo "<input style='height:30pt;width:120pt;font-size:20pt' type='submit' value='Learning'>";
			?>
			</form></td>
			<td align="center"><form action="reuest_driving.php" method="post" name="resuestdate">
			<?php
			$date = date("d/m/y");
			echo "<input type='hidden' name='date' value=".$date.">";
			echo "<input style='height:30pt;width:120pt;font-size:20pt' type='submit' value='Driving'>";
			?>
			</form></td>
			<!--<td align="center"><form action="reuest_vehicle.php" method="post" name="resuestdate">-->
			<?php
			$date = date("d/m/y");
			echo "<input type='hidden' name='date' value=".$date.">";
			//echo "<input style='height:30pt;width:120pt;font-size:20pt' type='submit' value='Vehicle'>";
			?>
			</form></td>
			<td align="center"><form action="reuest_permit.php" method="post" name="resuestdate">
			<?php
			$date = date("d/m/y");
			echo "<input type='hidden' name='date' value=".$date.">";
			echo "<input style='height:30pt;width:120pt;font-size:20pt' type='submit' value='Permit'>";
			?>
			</form></td>			
		</tr>
		</table>
