...
<div id="middle">
	...
	<div id="content_left">
		...
		<tr>
			<td align="center"><a href="delete_learning.html"><input style="height:30pt;width:120pt;font-size:20pt" type="button" value="Learning"> </a></td>
			<td align="center"><a href="delete_driving.html"><input style="height:30pt;width:120pt;font-size:20pt" type="button" value="Driving"> </a></td>
			<!--<td align="center"><a href="delete_vehicle.html"><input style="height:30pt;width:120pt;font-size:20pt" type="button" value="Vehicle"> </a></td>-->
			<td align="center"><a href="delete_permit.html"><input style="height:30pt;width:120pt;font-size:20pt" type="button" value="Permit"> </a></td>
		</tr>
		</table>
		</center>
		</div>	
