        ...
        <li class="menu_li" style="width:100px;" ><a class="menu_a" onmouseover="mopen('m4')" onmouseout="mclosetime()" href="status_learning.html">Status</a>
				<ul id="sub_menu">
					<li>
						...
						<a href="status_driving.html">Driving Licence </a>
...
<div id="middle">
	...
	<div id="content_left">
		...
		<tr>
			<td align="center"><a href="update_learning_status.html"><input style="height:30pt;width:120pt;font-size:20pt" type="button" value="Learning"> </a></td>
			<td align="center"><a href="update_driving_status.html"><input style="height:30pt;width:120pt;font-size:20pt" type="button" value="Driving"> </a></td>
			<!--<td align="center"><a href="update_vehicle_status.html"><input style="height:30pt;width:120pt;font-size:20pt" type="button" value="Vehicle"> </a></td>-->
			<td align="center"><a href="update_permit_status.html"><input style="height:30pt;width:120pt;font-size:20pt" type="button" value="Permit"> </a></td>
		</tr>
		</table>
		</center>
		</div>	
